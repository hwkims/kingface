...
def generate_prompt():
    ...
    All values except for "overall_impression" MUST be integers. The "features" object MUST contain exactly the 32 named facial features as keys.  Values for features should be between 0 and 100. Be specific. Do NOT include explanations.
    """
    return prompt
